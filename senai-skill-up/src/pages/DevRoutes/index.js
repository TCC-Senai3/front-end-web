...
const DevRoutes = () => {
    const routes = [
        ...
        { path: '/jogo', name: 'Jogo', status: 'pending', description: 'CSS - arrumar o tamanho dos elementos' },
        ...
        { path: '/Correto', name: 'Correto', status: 'pending', description: 'Arrumar a imagem' },
        { path: '/Errado', name: 'Errado', status: 'pending', description: 'Arrumar a imagem' },
        { path: '/LoadHost', name: 'LoadHost', status: 'pending', description: 'CSS - arrumar o tamanho dos elementos' },
        ...
        { path: '/createquiz', name: 'CreateQuiz', status: 'pending', description: 'CSS - arrumar o estilo' },
        { path: '/criarsala', name: 'CriarSala', status: 'pending', description: 'CSS - arrumar o estilo' },
        { path: '/sala', name: 'Sala', status: 'pending', description: 'CSS - arrumar o estilo' },
        { path: '/fim', name: 'FimDeJogo', status: 'pending', description: 'CSS - arrumar o estilo (pequenos detalhes)' },
