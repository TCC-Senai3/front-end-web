...
  // 🛑 CORREÇÃO AQUI: Mudamos de pontuacaoQuiz para acertos.
  const acertos = location.state?.acertos || 0; // Espera a contagem de acertos
...
          <p>
            {/* 🛑 CORREÇÃO NO DISPLAY: Usando 'acertos' em vez de 'pontuacaoQuiz' */}
            Você acertou <span className="score-highlight">{acertos}</span> de{" "}
