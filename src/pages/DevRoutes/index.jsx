...
const DevRoutes = () => {
    const routes = [
        ...
        { path: '/usuarios', name: 'Usuários', status: 'ok', description: 'CSS - arrumar o estilo' },
        ...
        { path: '/ForgotPassword', name: 'Forgot Password', status: 'ok', description: 'CSS - arrumar o estilo' },
        { path: '/ResetPassword', name: 'Reset Password', status: 'ok', description: 'CSS - arrumar o estilo' },
    ];
