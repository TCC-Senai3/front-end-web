...
  // --- Função: Clique na Alternativa (CORRIGIDA) ---
...
    const tempoGasto = tempoLimitePergunta - timeLeft;
    ...
    // ❌ REMOVEMOS: O cálculo incorreto de +1 no Front-end.
    /*
    if (acertou) {
...
      const apiResponse = await enviarResposta(respostaPayload);
      ...
      // ✅ 2. ATUALIZA O SCORE COM O VALOR CORRETO DO BACK-END
      ...
      if (acertou && apiResponse && apiResponse.pontuacaoTotalAtualizada !== undefined) {
          setScore(apiResponse.pontuacaoTotalAtualizada);
      }
...
          pontuacao: score, // O score aqui já deve estar atualizado
...
  useEffect(() => {
    if (showResultScreen) {
      // O tempo de espera agora é FIXO (3 segundos)
